...
(function($){		
	...
	/*
		...
		/*
		addParams('navl','navl','','',false); // feature of displaying source
		addParams('navu','navu','','',false); // feature of displaying source
		addParams('navr','navr','','',false); // feature of displaying source
		addParams('navd','navd','','',false); // feature of displaying source
		*/
		addParams('lt','Limpiar Texto','','',false); // feature of displaying source
